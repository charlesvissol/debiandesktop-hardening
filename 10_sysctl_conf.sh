...
sudo sysctl -a | grep net.ipv4.conf.all.accept_source_route >> /etc/sysctl.conf
...
sudo sysctl -a | grep net.ipv4.conf.default.accept_source_route >> /etc/sysctl.conf
...
sudo sysctl -w net.ipv6.conf.all.accept_ra=1 >> /etc/sysctl.conf
...
sudo sysctl -w net.ipv6.conf.default.accept_ra=1 >> /etc/sysctl.conf
