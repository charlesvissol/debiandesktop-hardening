...
exec > ./26_Docker_insecure.log 2>&1
...
sudo apt-get install -y --allow-unauthenticated docker-ce docker-ce-cli containerd.io docker-compose-plugin

echo "###############################################################################################"
echo "#   Step 26: Docker installation done - END                                                   #"
echo "#   See the log file 26_Docker_insecure.log                                                            #"
